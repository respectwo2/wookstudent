...
public class StringTest {
	...
	public static void main(String[] args) {
			...
			//		immutable(불변성) : 문자열 결합이나 삭제, 수정 등의 작업을 할때
		//								원본 문자열을 건들지 않고 새로 생성함.
		String s1="Java";
		s1+=" Language";
		...
		//String substring(int start, int end): 인덱스 start부터
		//						end-1까지의 문자열을 반환한다.
		...
		System.out.println("s4: "+s4); // replace했다고 원본이 바뀌진 않음, immutable
		...
		//String[] split(String regex): 특정 패턴 문자열을 기준으로
		//								문자열을 쪼개어 배열에 담아 반환.
