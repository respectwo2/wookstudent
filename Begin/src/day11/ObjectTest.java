...
public class ObjectTest {
	...
	public static void main(String[] args) {
		...
		//String클래스에서는 toString()을 오버라이드(재정의)하고있다
		...
		// == : 기본자료형일떄 값을 비교, 참조형일떄는 주소값을 비교한다.
		...
		System.out.println("st4.equals(st2): "+st4.equals(st2)); //new 하면 내용은 같지만 주소값이 다르다
