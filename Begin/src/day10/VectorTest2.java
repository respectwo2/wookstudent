...
public class VectorTest2 {
	...
	//	ArrayList<Student> al=new AraryList<>;
	//	Vector v = new Vector(5,5); // <여기에 저장할 공간>
		...
		//[4] for루프 이용해서 벡터에 저장된 학생의 정보(학번,이름) 출력
	for(Student a : v) {
		//System.out.println(a); // a.toString()를 호출하게됨
		...
		//iterator()메소드 이용해서 v에 저장된 학생 이름 모두 출력
